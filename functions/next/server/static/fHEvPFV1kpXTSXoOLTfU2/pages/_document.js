...
/* harmony import */ var aphrodite__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("t24B");
...
class MyDocument extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps({
    ...
    const {
      html,
      css
    } = aphrodite__WEBPACK_IMPORTED_MODULE_2__["StyleSheetServer"].renderStatic(() => renderPage());
    const {
  ...
  render() {
    return __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Html"], null, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, __jsx("style", null, `
        body {
          margin: 0;
          padding: 0;
